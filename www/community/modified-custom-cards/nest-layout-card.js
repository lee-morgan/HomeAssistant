// MODIFED FROM https://github.com/thomasloven/lovelace-layout-card
// Customized to fit my particular screen, YMMW
// Put this where you usually have your custom cards

customElements.whenDefined('card-tools').then(() => {
  let cardTools = customElements.get('card-tools');
  class NestLayoutCard extends cardTools.LitElement {
  ...
  customElements.define('nest-layout-card', NestLayoutCard);
  });
  window.setTimeout(() => {
